...
```bash
# Core
npm install next@15.2.13 react@19.0.0 react-dom@19.0.0 leaflet@1.9.4 react-leaflet@5.0.0 recharts@3.8.1 @prisma/client@7.8.0

# Supporting
npm install @tanstack/react-table@8.21.2 date-fns@4.1.0 lucide-react@0.475.0 simple-statistics@9.3.0 tailwind-merge@3.0.1 clsx@2.1.1 class-variance-authority@0.7.1 tailwindcss-animate@1.0.7

# Dev dependencies
npm install -D typescript@5.7.3 @types/node@20.11.0 @types/react@19.0.0 @types/react-dom@19.0.0 @types/leaflet@1.9.16 prisma@7.8.0 @faker-js/faker@10.4.0 tsx@4.19.2 tailwindcss@4.3.1 @tailwindcss/postcss@4.3.1 postcss@8.4.35
```
...
**If Map-Heavy Data Scaling is Needed (e.g., plotting >10,000 active medical incidents individually instead of region-level aggregations):**
...
**If High-Performance Trend Forecasting is Needed (e.g., real-time Prophet/ARIMA models):**
...
---
*Stack research for: Public Health Radar (Epidemiological Early Warning System)*
*Researched: June 17, 2026*
